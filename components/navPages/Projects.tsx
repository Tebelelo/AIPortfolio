...
const projects = [
...

  {
    ...
    description:
      "A full-stack web application designed to streamline IT support operations.",
    thumbnail: "/ticketing_system.png",
    techStack: ["ts", "react", "Node.js","PostgreSQL"],
    gradient: "#8A2BE2, rgb(13, 1, 60)",
    github: "https://github.com/Tebelelo/ticketing-system.git",
    live: "https://ticketing-system-frontend-edag.onrender.com/",
  },
  {
    title: "Dekago Movies",
    description:
      "DekagoMovies is a dynamic movie discovery platform that allows users to explore the latest films and top-rated shows",
    thumbnail: "/dekago.png",
    techStack: ["react"],
    gradient: "#8A2BE2, rgb(13, 1, 60)",
    descriptionColor: "text-white",
    github: "https://github.com/ADS4-Software-Development-Team/movie.git",
    live: "https://dekagomovies.vercel.app/",
  },
  {
