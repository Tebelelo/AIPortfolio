  ...
  return (
    ...
    >
      <p className="text-center">
        © {new Date().getFullYear()} Lekoana Tebelelo. All rights reserved.
      </p>

      <div className="flex gap-4 items-center">
        <a
          href="https://github.com/Tebelelo"
          target="_blank"
        ...
        <a
          href="https://www.linkedin.com/in/tebelekoana"
          target="_blank"
          rel="noopener noreferrer"
          className="hover:text-foreground transition-colors"
        >
        ...
        <a
          href="mailto:tebelekoana@gmail.com"
          className="hover:text-foreground transition-colors"
        >
